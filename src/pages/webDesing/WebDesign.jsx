...
function WebDesign() {
  return (
    ...
    <div className={styles.projects}>
      ...
      <FeatureCard title="TRANSFER" description="Site for low-cost money transfers and sending money within seconds" image={img2} />
      <FeatureCard title="PHOTON" description="A state-of-the-art music player with high-resolution audio and DSP effects" image={img3} />
      <FeatureCard title="BUILDER" description="Connects users with local contractors based on their location" image={img4} />
      <FeatureCard title="BLOGR" description="Blogr is a platform for creating an online blog or publication" image={img5} />
      <FeatureCard title="CAMP" description="Get expert training in coding, data, design, and digital marketing" image={img6} />
    </div>
